...
INSERT INTO 
	board (name)
VALUES
	('Project A'), ('Weekly Chores'), ('Kanban Project'), ('Bucketlist'),  ('Activities');
...
VALUES
    ...
    ('To Do', 3), ('In Progress', 3), ('Review', 3), 
    ('Completed', 3), ('Foods To Eat', 4), ('Places to Visit', 4), 
    ('Morning', 5), ('Afternoon', 5), ('Night', 5);
